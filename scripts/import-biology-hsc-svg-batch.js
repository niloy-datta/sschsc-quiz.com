/**
 * Import HSC Biology 1st Paper SVG batch (manifest + files in biology_hsc_svg_batch/).
 * Usage: node scripts/import-biology-hsc-svg-batch.js
 */
const fs = require("fs");
...
const SVG_DIR = path.join(__dirname, "biology_hsc_svg_batch");
