...
export const levelDetectorQuestions: QuizQuestion[] = [
  ...
  {
    id: "q5",
    question: "লজিক গেটের ক্ষেত্রে, কোন গেটটিকে 'সার্বজনীন গেট' বা Universal Gate বলা হয়?",
    options: [
      "AND গেট",
      "OR গেট",
      "NAND গেট",
    ...
    correctAnswer: 2, // NAND Gate
    explanation: "NAND এবং NOR গেট দিয়ে অন্য সকল মৌলিক লজিক গেট (AND, OR, NOT) তৈরি করা সম্ভব। তাই এদের সার্বজনীন গেট বলা হয়।",
